...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('he');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('he');
  CREATE TYPE "public"."enum_articles_category" AS ENUM('guides', 'halacha', 'news', 'stories');
  CREATE TYPE "public"."enum_articles_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_version_category" AS ENUM('guides', 'halacha', 'news', 'stories');
  CREATE TYPE "public"."enum__articles_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__articles_v_published_locale" AS ENUM('he');
  CREATE TYPE "public"."enum_stores_region" AS ENUM('jerusalem', 'center', 'south', 'north');
  CREATE TYPE "public"."enum_contact_submissions_source" AS ENUM('home', 'contact', 'newsletter');
  CREATE TABLE "pages" (
  ...
  CREATE TABLE "stores" (
  	...
  	"region" "enum_stores_region" NOT NULL,
  ...
  CREATE TABLE "contact_submissions" (
  	...
  	"phone" varchar NOT NULL,
  	"message" varchar,
  	"source" "enum_contact_submissions_source" DEFAULT 'home',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"upgrade_notice_enabled" boolean DEFAULT true,
  	"upgrade_notice_text" varchar DEFAULT 'האתר בתהליך שדרוג. ייתכן שחלק מהפונקציות אינן זמינות כרגע. עמכם הסליחה.',
  	"contact_phone" varchar DEFAULT '073-393-3000',
  	"contact_whatsapp" varchar,
  	"contact_email" varchar DEFAULT 'info@hadran.net',
  	"contact_hours" varchar DEFAULT 'א׳–ה׳ 09:00–19:00 · ו׳ 09:00–12:00',
  	"stats_user_count" numeric DEFAULT 140000,
  	"stats_founded_year" numeric DEFAULT 2014,
  	"kashrut_committee" varchar DEFAULT 'ועדת הרבנים לענייני תקשורת שע״י בד״צ בני ברק',
  	"kashrut_certificate_id" integer,
  ...
  ALTER TABLE "devices_specs" ADD CONSTRAINT "devices_specs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."devices"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "devices" ADD CONSTRAINT "devices_brand_id_brands_id_fk" FOREIGN KEY ("brand_id") REFERENCES "public"."brands"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "devices" ADD CONSTRAINT "devices_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_kashrut_certificate_id_media_id_fk" FOREIGN KEY ("kashrut_certificate_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "devices_specs_order_idx" ON "devices_specs" USING btree ("_order");
  CREATE INDEX "devices_specs_parent_id_idx" ON "devices_specs" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "devices_slug_idx" ON "devices" USING btree ("slug");
  CREATE INDEX "devices_brand_idx" ON "devices" USING btree ("brand_id");
  CREATE INDEX "devices_image_idx" ON "devices" USING btree ("image_id");
  ...
  CREATE INDEX "site_settings_kashrut_kashrut_certificate_idx" ON "site_settings" USING btree ("kashrut_certificate_id");`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "devices_specs" CASCADE;
  ...
  DROP TYPE "public"."enum_stores_region";
